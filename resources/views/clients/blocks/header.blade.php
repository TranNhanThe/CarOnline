<nav class="navbar navbar-expand-lg navbar-dark bg-rentalcard-in shadow fixed-top">
    <div class="container-fluid">
        <a class="navbar-brand" href="{{ route('home') }}"><img src="{{ asset('assets/clients/images/logotimotopj.png') }}"
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="{{ route('sell.index') }}">Danh sách xe bán</a>
                </li>
